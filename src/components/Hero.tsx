...
const Hero = () => {
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-white to-blue-50 pt-16">
      <div className="container mx-auto px-4 md:px-6 py-12 h-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-64px)]">
          <div className="flex flex-col space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-navy-dark animate-fade-in" style={{animationDelay: "0.3s"}}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 pt-8 animate-fade-in" style={{animationDelay: "0.9s"}}>
          ...
          <div className="hidden lg:flex justify-center relative animate-fade-in" style={{animationDelay: "1.1s"}}>
